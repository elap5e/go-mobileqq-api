...
func main() {
	...
	tmpl, err := template.New("face_gen").Parse(tmplEmoticonFace)
	if err != nil {
		panic(err)
	}
	buf := bytes.Buffer{}
	...
	file, err := os.OpenFile("face_gen.go", os.O_WRONLY|os.O_CREATE|os.O_SYNC|os.O_TRUNC, 0644)
	if err != nil {
		panic(err)
	}
	defer file.Close()
...
const tmplEmoticonFace = `// Code generated by go-mark-emoticon-gen, DO NOT EDIT.
...
const (
	UNKNOWN_Face FaceType = -1 // "/unknown"{{ range . }}
	{{ .Safe }}_Face FaceType = {{ .ID }} // "/{{ .Name }}"{{ end }}
)
...
func ParseFaceType(s string) (FaceType, error) {
	switch s {
	case "/unknown":
		return UNKNOWN_Face, nil{{ range . }}
	case "/{{ .Name }}":
		return {{ .Safe }}_Face, nil{{ end }}
	}
...
const jsonFaceConfig = `[
	...
	{"QSid":"5","QDes":"/流泪","IQLid":"9","AQLid":"9","EMCode":"105"},
	...
	{"QSid":"247","QDes":"/口罩护体","isStatic":"1","IQLid":"247","AQLid":"219","EMCode":"202003"},
	{"QSid":"260","QDes":"/搬砖中","isStatic":"1","IQLid":"260","AQLid":"260","EMCode":"10260"},
	{"QSid":"261","QDes":"/忙到飞起","IQLid":"261","AQLid":"261","EMCode":"10261"},
	...
	{"QSid":"317","QDes":"/菜狗","IQLid":"317","AQLid":"317","EMCode":"10317","AniStickerType":1,"AniStickerPackId":"1","AniStickerId":"7"},
	...
	{"QSid":"308","QDes":"/求红包","IQLid":"308","isCMEmoji":"1","AQLid":"308","EMCode":"20243"},
	{"QSid":"309","QDes":"/谢红包","IQLid":"309","isCMEmoji":"1","AQLid":"309","EMCode":"20244"},
	{"QSid":"310","QDes":"/新年烟花","IQLid":"310","isCMEmoji":"1","AQLid":"310","EMCode":"20245"},
	{"QSid":"290","QDes":"/敲开心","IQLid":"290","isCMEmoji":"1","AQLid":"290","EMCode":"20240"},
	{"QSid":"291","QDes":"/震惊","IQLid":"291","isCMEmoji":"1","AQLid":"291","EMCode":"20241"},
	...
	{"QSid":"279","QDes":"/打脸","IQLid":"279","isCMEmoji":"1","AQLid":"279","EMCode":"20238"},
	{"QSid":"280","QDes":"/击掌","IQLid":"280","isCMEmoji":"1","AQLid":"280","EMCode":"20239"},
	...
	{"QSid":"148","QDes":"/喝奶","isStatic":"1","IQLid":"118","AQLid":"120","EMCode":"121013"},
	{"QSid":"274","QDes":"/太南了","isStatic":"1","IQLid":"274","AQLid":"274","EMCode":"10274"}, 
	{"QSid":"113","QDes":"/啤酒","IQLid":"61","AQLid":"61","EMCode":"157"},
	{"QSid":"140","QDes":"/K歌","isStatic":"1","IQLid":"110","AQLid":"112","EMCode":"121005"},
	{"QSid":"53","QDes":"/蛋糕","IQLid":"59","AQLid":"59","EMCode":"168"},
	{"QSid":"188","QDes":"/蛋","IQLid":"158","AQLid":"180","EMCode":"258"},
	{"QSid":"55","QDes":"/炸弹","isStatic":"1","IQLid":"16","AQLid":"16","EMCode":"170"},
	...
	{"QSid":"145","QDes":"/祈祷","isStatic":"1","QHide":"1","IQLid":"115","AQLid":"117","EMCode":"121010"},
	{"QSid":"117","QDes":"/瓢虫","IQLid":"62","AQLid":"62","EMCode":"173"},
	{"QSid":"168","QDes":"/药","isStatic":"1","IQLid":"138","AQLid":"140","EMCode":"121033"},
	{"QSid":"114","QDes":"/篮球","IQLid":"90","AQLid":"92","EMCode":"158"},
